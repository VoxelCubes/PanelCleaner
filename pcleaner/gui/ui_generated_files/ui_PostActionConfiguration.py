...
#if QT_CONFIG(tooltip)
        self.pushButton_row_up.setToolTip(QCoreApplication.translate("PostActionConfiguration", u"Move box order up", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        self.pushButton_row_down.setToolTip(QCoreApplication.translate("PostActionConfiguration", u"Move box order down", None))
#endif // QT_CONFIG(tooltip)
